...
zstyle ':fzf-tab:complete:git*:*' fzf-flags --height=50% --preview-window=right:70%
...
zstyle ':fzf-tab:complete:mvn-dependency:*' fzf-preview 'grep -A5 "<$word" pom.xml 2>/dev/null | bat --color=always --style=plain -l xml'
...
zstyle ':fzf-tab:complete:(\\|)man:*' fzf-preview 'man $word 2>/dev/null | bat -plman --color=always'
